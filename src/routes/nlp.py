...
async def index_project(request:Request,project_id:int,push_request:PushRequest):
    ...
    # setup batching
    total_chunk_count = await chunk_model.get_total_chunk_count(project_id=project.project_id)
    pbar = tqdm(total=total_chunk_count,
                desc="Vector Indexing",position=0)
...
async def get_project_info(request:Request,project_id:int):
